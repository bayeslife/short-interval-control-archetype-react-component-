...
const DEMO_SOURCE_DIR=process.env.DEMO_SOURCE_DIR || 'demo-client-server'
console.log(`Demo Source Dir: ${DEMO_SOURCE_DIR}`)

const htmlWebpackPlugin = new HtmlWebpackPlugin({
    template: path.join(__dirname, `../../${DEMO_SOURCE_DIR}/client/index.html`),
    filename: "./index.html",
...
module.exports = {
    entry: path.join(__dirname, `../../${DEMO_SOURCE_DIR}/client/index.js`),
    output: {
